...
class SeteDiasController extends Controller
{
    public function userID()
    {
        ...
        if ($usuarioExistente == true) {
            ...
            if ($podeLiberarSeteDias) {
                ...
                $expiresIn = (new \DateTime('+7 days'))->format('Y-m-d\TH:i:s\Z');
                ...
                if (isset($retornoLiberacao->id)) {
                    ...
                    return redirect()->route('assine')->withErrors(['status' => 'Parabéns Plano de 7 dias liberado com sucesso!']);
