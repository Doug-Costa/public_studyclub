    ...
    <div class="container pb-4">
      <div class="row">
        <div class="text-lg-left text-left align-self-left pt-4 col-md-6 py-3" style="">
          <h1 class="text-white"><b class="">¡Regístrate al lado y aprovecha un 20% de descuento exclusivo para miembros de Alado en DentalGO </b></h1>
          <p class="text-white"><b>la plataforma más grande de la odontología brasileña!<br></b><br>
        </div>
        <div class="col-md-6" style="">
        <!--formulario-->
          <div class="container_form" id="container_form" style="padding-left:40px !important; padding-right: 40px;">
              ...
              <form id="formCad" method="POST" action="{{ route('cadastro') }}" enctype="multipart/form-data">
                  ...
                  <div class="row">
                      <div class="mb-3" style="width:100% !important;">
                          <label for="nome" class="form-label">Inserte su nombre completo *</label>
                          <input type="text" name="nome" class="form-control" id="InputNome" aria-describedby="yourName" required>
                      </div>
                  </div>
                  <div class="row">
                      <div class="mb-3">
                          <label for="telefone" class="form-label">Número de teléfono</label>
                          <div class="row">
                              <div class="col-md-3">
                              ...
                              <div class="col-md-9">
                                  ...
                                  <div id="yourPhone" class="form-text">Si posee DDD del estado, ¡infórmelo!</div>
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="row">
                      <div class="mb-3" style="width:100% !important;">
                          <label for="E-mail" class="form-label">Ingrese su correo electrónico *</label>
                          <input type="email" name="email" class="form-control" id="InputEmail" aria-describedby="emailCadastro" required>
                          <div id="emailCadastro" class="form-text">¡Este también será su login en DentalGO!</div>
                      </div>
                  </div>

                  <div class="row">
                      <div class="mb-3" style="width:100% !important;">
                          <label for="password" class="form-label">Cree su contraseña *</label>
                  ...
                  <div class="form-group form-check mb-3" style="width:100% !important;">
                      ...
                      <label class="form-check-label" for="CheckTermos">He leído y acepto los términos de uso y política de privacidad de DentalGO.<a href="#" style="color: black; font-weight:bold; text-decoration: none;"> {{__("messages.ModCadTermos2")}}</a> {{__("messages.ModCadTermos3")}} <a href="#" style="color: black; font-weight:bold; text-decoration: none;">{{__("messages.ModCadTermos4")}}</a> {{__("messages.ModCadTermos5")}}</label>
                  </div>

                  <div class="row">
                      <div class="mb-3">
                          <input type="submit" value="Registrar" class="btn btn-danger dropdown-toggle botaoLogar" style="float: right;">
                      </div>
                  </div>
              </form>
          </div><!--container_form-->
