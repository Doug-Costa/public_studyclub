...
@section('content')
          ...
          @if($semImagem == 0)
            <div class="col-12 col-lg-6 col-sm-4">
              ...
              <div class="col mt-4">
                ...
                <a href="{{ route('artigo') }}/{{ $revista[0]->id }}/{{ str_replace(' ', '-', $revista[0]->title) }}/{{$anterior}}/"
                  class="btn btn-secondary btn-prox-artigo button-pagearticle">{{__("messages.ArtigoBladeAnterior")}}</a>
                <?php      endif; ?>
                <?php      if ($encontrado && $posterior): ?>
                <a href="{{ route('artigo') }}/{{ $revista[0]->id }}/{{ str_replace(' ', '-', $revista[0]->title) }}/{{$posterior}}/"
                                ...
                                <div class="row boxbordas1"
                                  ...
                                  <div class="col-12 col-lg-10 col-sm-8"
                                    ...
                                    <a class="nav-link p-1 article-content-options text-title text-title-1 mb-0"
                                      href="{{ route('artigo') }}/{{ $revista[0]->id }}/{{ str_replace(' ', '-', $revista[0]->title) }}/{{ $capitulo->id }}/{{ str_replace(' ', '-', $capitulo->title) }}">{{$capitulo->title}}</a>
                                    ...
                                    <div style="display:flex;">
                                      <a class="lerartigobotao btn btn-secondary"
                                        ...
                                        href="{{ route('artigo') }}/{{ $revista[0]->id }}/{{ str_replace(' ', '-', $revista[0]->title) }}/{{ $capitulo->id }}/{{ str_replace(' ', '-', $capitulo->title) }}">{{__("messages.ColecoesLeia")}}</a>
                                    </div>
                                  </div>
                                </div>
                              @else
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      @if(null !== Request()->segment(4) && $modalConteudo == 'permitido')
        setTimeout(function () {
          const articleId = "{{ Request()->segment(4) }}";
