...
<head>
    ...
    <title>Erro Inesperado - DentalGo</title>
...
<body>
    <div class="error-container">
        ...
        <h1>500 <span>Algo deu errado</span></h1>
        <h2>Erro Inesperado</h2>
        <p>Identificamos uma falha técnica ao processar sua solicitação. <br>Nossa equipe já foi notificada e está
            trabalhando na correção.</p>
