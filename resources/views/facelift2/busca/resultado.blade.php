...
<div class="new-design-scope" style="margin-top: 100px; min-height: 80vh;">
    <div class="container mx-auto px-4 py-8">
        ...
        @php
            $guitarTriggers = ['guitarra', 'guitar', 'rock', 'rock metal'];
            $isGuitar = in_array(strtolower($query ?? ''), $guitarTriggers);
            $isPiano = strtolower($query ?? '') == 'piano';
        @endphp

        @if($isPiano)
            <div class="container mx-auto mt-4 mb-8 flex justify-center">
