...
<body>
    <div class="container-fluid produtoTopo produtoTopo" style="background: url({{ asset('imagens/minhacontafundo.png') }}) no-repeat top center fixed !important;">
        <div class="container containerColecao">
            <div class="row">
                <h1 style="display: flex; color: #fff; font-size: 75px; align-items: center;">{{__("messages.MinhaContaBooksMinha")}}</h1>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <ul class="nav nav-tabs centerTab" id="myTab" role="tablist">
                  <li class="nav-item centerTab" role="presentation">
                    <button class="nav-link buscaLink active" id="minhabiblioteca-tab" data-bs-toggle="tab" data-bs-target="#minhabiblioteca" type="button" role="tab" aria-controls="minhabiblioteca" aria-selected="true"> {{__("messages.MinhaContaBooksMinhaLibrary")}}</button>
                  </li>
                  <li class="nav-item centerTab" role="presentation">
                    <button class="nav-link buscaLink" id="minhaconta-tab" data-bs-toggle="tab" data-bs-target="#minhaconta" type="button" role="tab" aria-controls="minhaconta" aria-selected="false">{{__("messages.MinhaContaBooksMinhaAccount")}}</button>
                  </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container tab-content" id="myTabContent" style="margin-top: 50px; margin-bottom: 50px;">
        ...
        <div class="tab-pane fade show active" id="minhabiblioteca" role="tabpanel" aria-labelledby="minhabiblioteca-tab">
            <div class="row" style="margin-bottom: 30px;">
                <div class="col-sm-12">
                    <h1>{{__("messages.MinhaContaBooksSeusProd")}}</h1>
                </div>
            </div>
            <div class="row">
                @if(count($minhaconta['minhabiblioteca']->rows) == 0)

                <h2>{{__("messages.MinhaContaBooksNoProd")}}</h2>

                @else

                    @foreach ($minhaconta['minhabiblioteca']->rows as $key => $produto)
                        <article class="col-6 col-md-3 col-lg-2">
                            <a href="{{ route('produtocompradobooks') }}/{{ $produto->id }}/{{ str_replace(' ', '-', $produto->title) }}" alt="{{ $produto->title }} - {{ $produto->brief }}" class="tiraUnderline">
        ...
        <div class="tab-pane fade show" id="minhaconta" role="tabpanel" aria-labelledby="minhaconta-tab">
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div id="yourPhone" class="form-text">{{__("messages.MinhaContaBooksDdd")}}</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <input type="submit" value="Atualizar" class="form-control btn btn-danger dropdown-toggle botaoLogar">
                        </div>
                    </div>
                </form>
            </div>
            @if($numeroDDI == 55)
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1>{{__("messages.MinhaContaBooksDdd")}}</h1>
                    </div>
                    <div class="co-sm-12">
                        ...
                        @csrf
                            <div class="row">
                                <div class="col-sm-5 mb-3">
                                    <label for="cep" class="form-label">{{__("messages.MinhaContaBooksCep")}}</label>
                                ...
                                <div class="col-sm-5 mb-3">
                                    <label for="cidade" class="form-label">{{__("messages.MinhaContaBooksCity")}}</label>
                                ...
                                <div class="col-sm-2 mb-3">
                                    <label for="uf" class="form-label">{{__("messages.MinhaContaBooksUf")}}UF</label>
                            ...
                            <div class="row">
                                <div class="col-sm-8 mb-3">
                                    <label for="endereco" class="form-label">{{__("messages.MinhaContaBooksLogra")}}</label>
                                ...
                                <div class="col-sm-4 mb-3">
                                    <label for="numero" class="form-label">{{__("messages.MinhaContaBooksNum")}}</label>
                            ...
                            <div class="row">
                                <div class="col-sm-8 mb-3">
                                    <label for="bairro" class="form-label">{{__("messages.MinhaContaBooksBairro")}}</label>
                                ...
                                <div class="col-sm-4 mb-3">
                                    <label for="complemento" class="form-label">{{__("messages.MinhaContaBooksDdd")}}Complemento</label>
