...
.laranjinha {
  ...
  .expand-all-items {
   ...
   <img class="img-fluid banner-desktop" src="{{ asset('imagens/teste/sh3d1.png') }}" alt="" style="margin-top: 30px; min-height: 400px; object-fit: cover;">
   <div class="container banner-desktop">
      <div class="row text-start" style="margin-top:-200px;">
         ...
         <h2 class="dscore-subtitulo" style="margin-top: 60px;">Fluxo digital completo do Escaneamento à Impressão 3D </h2>
      </div>
   </div>
   <div class="container-fluid banner-mobile banner-teste" >
      <div class="container">
         <div class="row text-start" style="margin-top:00px;">
            ...
            <h2 class="dscore-subtitulo" style="font-size:20px; line-height: 30px; margin-bottom: unset;">Fluxo Digital Completo Do Escaneamento a Impressão 3D</h2>
         </div>
      </div>
   </div>

   <div class="container-fluid" style="padding-top: 100px; padding-bottom: 70px; background-color: #fff;">

      <div class="row justify-content-center section-fluxo">
         
         <div class="col-lg-4 col-md-4 teste-borda expand-all-items" style="border-radius: 10px; padding: 24px;">
      ...
      <div class="col-12">
         <div class="row">
            ...
            <div class="col-12 col-md-8 text-center mt-3" style="margin-bottom: 15px;">
               ...
               <a href="https://www.youtube.com/watch?v=iqUSRgZVKjw" target="_blank">
                  <video id="videoPlayer" style="width:100%; border-radius: 10px;" autoplay muted loop pause>
