...
<head>
    ...
    <title>Dental GO 7 Dias Cadastro</title>
    ...
    <div class="container pt-5 pb-4">
      <div class="row">
        ...
        <div class="text-lg-left text-left align-self-left pt-4 col-md-6 py-3" style="">
          <h1 class="text-white"><b class="">Cadastre-se ao lado e aproveite 7 dias grátis do DentalGO </b></h1>
        ...
        <!--formulario-->
          <div class="container_form" id="container_form" style="padding-left:40px !important; padding-right: 40px;">
              ...
              <form id="formCad" method="POST" action="{{ route('setediascad') }}" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
